    ...
    public class TodoController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Todos != null ? 
                          ...
                          .AsNoTracking()
                          // função para mostrar somente as informações pertinentes ao usuário logado
                          .Where(x => x.User == User.Identity.Name)
                          .ToListAsync()) : Problem("Entity set 'ApplicationDbContext.Todos'  is null.");
        }
